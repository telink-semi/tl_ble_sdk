...
* TL721X
    - Compiling acl_central_demo
        - Flash bin size:  113.99 KB
        - IRAM size: 61 KB
        - DRAM size: 0.41 KB
    - Compiling acl_connection_demo
        - Flash bin size: 136.78 KB
        - IRAM size: 72.53 KB
        - DRAM size: 0.66 KB
    - Compiling acl_peripheral_demo
        - Flash bin size: 119.77 KB
        - IRAM size: 61.25 KB
        - DRAM size: 0.64 KB
    - Compiling eslp_ap_dmeo
...
* TL321X
    - Compiling acl_central_demo
        - Flash bin size: 116.97 KB
        - IRAM size: 59.95 KB
        - DRAM size: 0.39 KB
    - Compiling acl_connection_demo
        - Flash bin size: 139.72 KB
        - IRAM size: 71.49 KB
        - DRAM size: 0.64 KB
    - Compiling acl_peripheral_demo
...
* TL322X
    - Compiling acl_central_demo
        - Flash bin size: 120.28 KB
        - IRAM size: 64.58 KB
        - DRAM size: 0.43 KB
    - Compiling acl_connection_demo
        - Flash bin size: 143.60 KB
        - IRAM size: 75.86 KB
        - DRAM size: 0.68 KB
    - Compiling acl_peripheral_demo
        - Flash bin size:  126.51 KB
        - IRAM size: 64.58 KB
        - DRAM size: 0.69 KB
* TL323X
    - Compiling acl_central_demo
        - Flash bin size: 117.75 KB
        - IRAM size: 61.78 KB
        - DRAM size: 0.40 KB
    - Compiling acl_connection_demo
        - Flash bin size: 141.22 KB
        - IRAM size: 73.81 KB
        - DRAM size: 0.65 KB
    - Compiling acl_peripheral_demo
...
* SDK Version: tl_ble_sdk V4.0.4.7
* Chip Version: 
    - TLSR921X(B91):           A2
    - TLSR922X/TLSR952X(B92):  A3/A4
    - TL721X:                  A2/A3
...
* Hardware EVK Version:
    ...
    - TL323X:                  C1T388A20_V1.1
* Platform Version: 
    - TLSR921X:                tl_platform_sdk V3.11.0
    - TLSR922X/TLSR952X:       tl_platform_sdk V3.11.0
    - TL721X:                  tl_platform_sdk V3.11.0
    - TL321X:                  tl_platform_sdk V3.11.0
    - TL322X:                  tl_platform_sdk V3.11.0
...
* For all chips, synchronized tl_platform_sdk V3.11.0;
...
* 对于所有芯片，同步 tl_platform_sdk V3.11.0。
