...
static inline void gpio_init(int anaRes_init_en)
{
    ...
    reg_gpio_pf_setting1 =
        ...
        (PF4_DATA_OUT<<28)  | (PF5_DATA_OUT<<29)    | (PF6_DATA_OUT<<30)    | (PF7_DATA_OUT<<31) ;
    ...
    reg_gpio_pg_setting1 =
        ...
        (PG0_DATA_OUT<<24)  | (PG1_DATA_OUT<<25)    | (PG2_DATA_OUT<<26)    | (PG3_DATA_OUT<<27) |
        (PG4_DATA_OUT<<28)  | (PG5_DATA_OUT<<29);
    reg_gpio_pg_ds =
        (PG0_DATA_STRENGTH<<0)  | (PG1_DATA_STRENGTH<<1)  | (PG2_DATA_STRENGTH<<2)  | (PG3_DATA_STRENGTH<<3) |
        (PG4_DATA_STRENGTH<<4)  | (PG5_DATA_STRENGTH<<5) ;
    reg_gpio_pg_gpio =
        (PG0_FUNC==AS_GPIO ? BIT(0):0)  | (PG1_FUNC==AS_GPIO ? BIT(1):0)| (PG2_FUNC==AS_GPIO ? BIT(2):0)| (PG3_FUNC==AS_GPIO ? BIT(3):0) |
        (PG4_FUNC==AS_GPIO ? BIT(4):0)  | (PG5_FUNC==AS_GPIO ? BIT(5):0);
    if(anaRes_init_en)
    {
