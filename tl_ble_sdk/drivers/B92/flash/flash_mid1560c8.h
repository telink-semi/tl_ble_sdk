 ...
 * @note    when data protection, only enumeration items in mid1560c8_lock_block_e can be selected,
 *          to ensure that the values returned by the interface flash_get_lock_block_mid1560c8 are in the mid1560c8_lock_block_e.
 */
typedef enum{
    //--------- CMP bit = 0-----------------//
