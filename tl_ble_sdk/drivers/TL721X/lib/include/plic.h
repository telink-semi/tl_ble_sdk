...
#define IRQ_CHACHA20                50 /* CHACHA20_IRQ, - chacha20_irq_handler */
 ...
 */
 //BLE SDK use: in IRQ _attribute_ram_code_sec_
static inline  _attribute_ram_code_sec_ void plic_set_threshold(irq_threshold_e threshold)
{
