 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid156085(unsigned short data, mid156085_write_status_mask_e mask)
{
    if (0 != (data & ~mask))
    {
        return 2;
    ...
    if(data != (status & mask)) //To reduce the operation of the status register.
    {
        ...
        status = flash_read_status_mid156085();
    }
    if(data == (status & mask))
    {
        return 1;
...
{
    flash_write_config_mid156085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID156085);
    return flash_write_status_mid156085(data, FLASH_WRITE_STATUS_BP_MID156085);
}
...
{
    flash_write_config_mid156085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID156085);
    return flash_write_status_mid156085(FLASH_LOCK_NONE_MID156085, FLASH_WRITE_STATUS_BP_MID156085);
}
...
{
    return flash_read_status_mid156085()&FLASH_WRITE_STATUS_BP_MID156085;
}
...
{
    flash_write_status_mid156085(data, FLASH_WRITE_STATUS_OTP_MID156085);
}
