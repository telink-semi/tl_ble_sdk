...
unsigned char flash_4line_en(unsigned int flash_mid)
{
    ...
    case MID166085:
        ...
        break;
    case MID182085:
        return flash_write_status_mid182085(FLASH_QE_ENABLE_MID182085, FLASH_WRITE_STATUS_QE_MID182085);
        break;
    default:
        return 3;
        break;
...
unsigned char flash_4line_dis(unsigned int flash_mid)
{
    ...
    case MID166085:
        ...
        break;
    case MID182085:
        return flash_write_status_mid182085(FLASH_QE_DISABLE_MID182085, FLASH_WRITE_STATUS_QE_MID182085);
        break;
    default:
        return 3;
        break;
