...
/*
 * @brief     MID = 0x166085 Flash include P25Q32SU.
 */


/**
 * @brief   define the section of the protected memory area which is read-only and unalterable.
 * @note    when data protection, only enumeration items in mid166085_lock_block_e can be selected,
 *          to ensure that the values returned by the interface flash_get_lock_block_mid166085 are in the mid166085_lock_block_e.
 */
typedef enum{
    //---------WPS=0, CMP bit = 0-----------------//
