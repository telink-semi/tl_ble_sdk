 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid182085(unsigned short data, mid182085_write_status_mask_e mask)
{
    if (0 != (data & ~mask))
    {
        return 2;
    ...
    unsigned short status = flash_read_status_mid182085();
    if(data != (status & mask))    //To reduce the operation of the status register.
    {
        ...
        status = flash_read_status_mid182085();
    }
    if(data == (status & mask))
    {
        return 1;
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_lock_mid182085(mid182085_lock_block_e data)
{
    flash_write_config_mid182085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID182085);
    return flash_write_status_mid182085(data, FLASH_WRITE_STATUS_BP_MID182085);
}
...
{
    flash_write_config_mid182085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID182085);
    return flash_write_status_mid182085(FLASH_LOCK_NONE_MID182085, FLASH_WRITE_STATUS_BP_MID182085);
}
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
mid182085_lock_block_e flash_get_lock_block_mid182085(void)
{
    return flash_read_status_mid182085()&FLASH_WRITE_STATUS_BP_MID182085;
}
...
{
    flash_write_status_mid182085(data, FLASH_WRITE_STATUS_OTP_MID182085);
}
