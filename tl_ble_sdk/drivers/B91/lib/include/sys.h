...
/**
 * @brief:    Whether to close the internal capacitor.
 * @note:    The corresponding parameters must be configured according to the circuit, otherwise,
 *             it may result in the parallel connection of two capacitors or no capacitors,
 *             which may lead to inaccurate crystal frequency, slow crystal oscillation, and reset issues.
 */
typedef enum{
    INTERNAL_CAP_XTAL24M = 0, //Use an external 24M crystal and internal capacitors,turn on internal capacitance.
    EXTERNAL_CAP_XTAL24M = 1, //Use an external 24M crystal and external capacitors,turn off internal capacitance.
}cap_typedef_e;
