...
#if 1 //just clear warning
#define __PROJECT_ESLP_AP_DEMO__                     0
#define CS_EBQ_TEST                                 0
#define ESL_INFO_SAVED_BY_CUSTOMER                  0
#define HADM_PHASE_CONTINUITY                       0
#define LL_FEATURE_SUPPORT_PERIODIC_ADVERTISING_WITH_RESPONSES_ADVERTISER 1
#define MI_CONTROLLER_EN                            0
#define PRF_INFO_SAVED_BY_CUSTOMER                  0
#define RAS_IOPTEST_ENABLE                          0
#define RAS_IOPTEST_ENABLE                          0
#define RAS_TIMEOUT_EN                              0
#define TTF_EN                                      0
#endif
...
#define SCHEDULER_USE_STIMER_TICK_REPLACE_BIG_SMALL_SLOT                1
