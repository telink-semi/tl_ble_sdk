        ...
        if (conn_adv_flag) {
            ...
            if (central_auto_connect || user_manual_pairing) {
                ...
                if (conn_adv_flag == 1) { //legacy
                    ...
                    status = blc_ll_extended_createConnection(INITIATE_FP_ADV_SPECIFY, OWN_ADDRESS_PUBLIC, pExtAdvInfo->address_type, pExtAdvInfo->address, INIT_PHY_1M, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S);
                    ...
                    status = blc_ll_extended_createConnection(INITIATE_FP_ADV_SPECIFY, OWN_ADDRESS_PUBLIC, pExtAdvInfo->address_type, pExtAdvInfo->address, INIT_PHY_1M_2M_CODED, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, CONN_INTERVAL_31P25MS, CONN_INTERVAL_31P25MS, CONN_TIMEOUT_4S);
    ...
    if (h & HCI_FLAG_EVENT_BT_STD) //Controller HCI event
    {
        ...
        } else if (evtCode == HCI_EVT_LE_META)         //LE Event
        {
            ...
            else if (subEvt_code == HCI_SUB_EVT_LE_CONNECTION_UPDATE_COMPLETE) // connection update
            {
                ...
                tlkapi_printf(APP_CONTR_EVT_LOG_EN, "app connect update complete handle:%04X  connInterval:%04X  connLatency::%04X Timeout:%04X", pUpt->connHandle, pUpt->connInterval, pUpt->connLatency, pUpt->supervisionTimeout);
            } else if (subEvt_code == HCI_SUB_EVT_LE_DATA_LENGTH_CHANGE) // connection update
            {
                ...
                tlkapi_printf(APP_CONTR_EVT_LOG_EN, "app data length change  handle:%04X  maxRxOct:%04X  maxTxOct:%04X", pEvt->connHandle, pEvt->maxRxOct, pEvt->maxTxOct);
            }
        }
    }
...
_attribute_no_inline_ void user_init_normal(void)
{
    ...
    blc_hci_le_setEventMask_cmd(HCI_LE_EVT_MASK_CONNECTION_COMPLETE | HCI_LE_EVT_MASK_ADVERTISING_REPORT | HCI_LE_EVT_MASK_CONNECTION_UPDATE_COMPLETE | HCI_LE_EVT_MASK_ENHANCED_CONNECTION_COMPLETE | HCI_LE_EVT_MASK_DATA_LENGTH_CHANGE | HCI_LE_EVT_MASK_EXTENDED_ADVERTISING_REPORT);
    ...
    ScanReturn = blc_ll_setExtScanParam(OWN_ADDRESS_PUBLIC, SCAN_FP_ALLOW_ADV_ANY, SCAN_PHY_1M, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS);
        #elif (EXT_SCAN_TEST_MODE == APP_EXT_SCAN_CODED)    //Scan Coded PHY only
    ScanReturn = blc_ll_setExtScanParam(OWN_ADDRESS_PUBLIC, SCAN_FP_ALLOW_ADV_ANY, SCAN_PHY_CODED, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS);
        #elif (EXT_SCAN_TEST_MODE == APP_EXT_SCAN_1M_CODED) //Scan Coded PHY only
    ScanReturn = blc_ll_setExtScanParam(OWN_ADDRESS_PUBLIC, SCAN_FP_ALLOW_ADV_ANY, SCAN_PHY_1M_CODED, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS, SCAN_TYPE_PASSIVE, SCAN_INTERVAL_100MS, SCAN_WINDOW_100MS);
        #else
