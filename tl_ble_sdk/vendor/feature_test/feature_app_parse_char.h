...
#elif (BOARD_SELECT == BOARD_721X_EVK_CIT314A102)
#define PARSE_CHAR_UART_TX_PIN GPIO_FC_PF3
#define PARSE_CHAR_UART_RX_PIN GPIO_FC_PF2
#elif (BOARD_SELECT == BOARD_321X_EVK_C1T335A20)
#define PARSE_CHAR_UART_TX_PIN GPIO_FC_PC7
#define PARSE_CHAR_UART_RX_PIN GPIO_FC_PC6
#else
#warning "Board not sellected!"
#endif
...
#ifndef APP_PARSE_CHAR_UART
#define APP_PARSE_CHAR_UART 1
#endif

#ifndef APP_PARSE_CHAR_USB_CDC
#define APP_PARSE_CHAR_USB_CDC 2
#endif

#ifndef APP_PARSE_CHAR_IFACE
#define APP_PARSE_CHAR_IFACE APP_PARSE_CHAR_UART
#endif

#ifndef APP_PARSE_CHAR_ENABLE
...
/**
 * @brief        parse string to bytes array
 * @param[in]    ps: value string, '\0' ending, supported -1, -0xAB, 1.
 * @return        number of bytes parsed
 */
u16 app_parse_str2hex(char *ps, u8 *data, u16 data_len);
