 ...
 *
 *******************************************************************************************************/
#ifndef DEFAULT_BUFFER_H_
#define DEFAULT_BUFFER_H_
 ...
 * different feature project can share default_buffer.h/efault_buffer.c
 */
#ifndef APP_DEFAULT_BUFFER_ACL_OCTETS_MTU_SIZE_MINIMUM
 ...
 */
    ...
    #define ACL_PERIPHR_MAX_TX_OCTETS           52
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_56_BYTES)
    #define ACL_PERIPHR_MAX_TX_OCTETS           56
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_100_BYTES)
    #define ACL_PERIPHR_MAX_TX_OCTETS           100
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_200_BYTES)
    #define ACL_PERIPHR_MAX_TX_OCTETS           200
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES)
...
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_52_BYTES)
    #define ACL_CENTRAL_MAX_TX_OCTETS       52
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_56_BYTES)
    #define ACL_CENTRAL_MAX_TX_OCTETS       56
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_100_BYTES)
    #define ACL_CENTRAL_MAX_TX_OCTETS       100
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_200_BYTES)
    #define ACL_CENTRAL_MAX_TX_OCTETS       200
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES)
 ...
 */
#define CENTRAL_ATT_RX_MTU              247 //user set value
#define PERIPHR_ATT_RX_MTU              247 //user set value
...
extern _attribute_ble_data_retention_ u8 mtu_size[ACL_CENTRAL_MAX_NUM + ACL_PERIPHR_MAX_NUM];
