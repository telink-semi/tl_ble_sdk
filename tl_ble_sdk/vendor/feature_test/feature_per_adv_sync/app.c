...
int app_le_periodic_adv_sync_established_event_handle(u8 *p)
{
    ...
    tlkapi_printf(APP_CONTR_EVT_LOG_EN,"[APP][EVENT]periodic_adv_sync_established syncHandle:%04X mac:%02X %02X %02X %02X %02X %02X",\
                pExt->syncHandle,pExt->advAddr[0],pExt->advAddr[1],pExt->advAddr[2],\
                pExt->advAddr[3],pExt->advAddr[4],pExt->advAddr[5]);
    return 0;
}
