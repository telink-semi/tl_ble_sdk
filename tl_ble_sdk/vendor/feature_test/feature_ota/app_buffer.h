 ...
 */
    ...
    #define ACL_CENTRAL_MAX_TX_OCTETS        251    //user set value //cover biggest OTA PDU length 240 Bytes
#else
...
#define ACL_RX_FIFO_NUM                    16    //user set value
 ...
 */
#if(OTA_CLIENT_SUPPORT_BIG_PDU_ENABLE)
    #define CENTRAL_ATT_RX_MTU              250    //user set value
#else
    #define CENTRAL_ATT_RX_MTU              23    //user set value
#endif

#if(OTA_SERVER_SUPPORT_BIG_PDU_ENABLE)
    #define PERIPHR_ATT_RX_MTU               250    //user set value
#else
