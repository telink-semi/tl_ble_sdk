...
const u8    tbl_advData[] = {
     10, DT_COMPLETE_LOCAL_NAME,                'w','h','i','t','e','l','i','s','t',
...
//////////////////////////// User Configuration for BLE application ////////////////////////////
    ...
    if (bond_number) //use whitelist to filter device
    {
        ...
        blc_ll_setAdvParam(ADV_INTERVAL_200MS, ADV_INTERVAL_200MS, ADV_TYPE_CONNECTABLE_UNDIRECTED, OWN_ADDRESS_PUBLIC,
    ...
    {
        blc_ll_setAdvParam(ADV_INTERVAL_200MS, ADV_INTERVAL_200MS, ADV_TYPE_CONNECTABLE_UNDIRECTED, OWN_ADDRESS_PUBLIC,
                0, NULL, BLT_ENABLE_ADV_ALL, ADV_FP_ALLOW_SCAN_ANY_ALLOW_CONN_ANY);
    }
